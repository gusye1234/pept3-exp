...
if __name__ == "__main__":
    ...
    for which in ["sprot_human", "IGC", "sprot_all", "sprot_bacteria_human"]:
        ...
        save_tab1 = f"/data/prosit/figs/figure6/{which}/percolator/try/{frag_model}/no_finetuned_twofold"
    ...
    for which in ["trypsin", 'chymo', "lysc", "gluc"]:
        ...
        save_tab1 = f"/data/prosit/figs/fig235/{which}/percolator_up/try/{frag_model}/no_finetuned_twofold"
    ...
    save_tab1 = f"/data/prosit/figs/figure5/percolator/try/{frag_model}/no_finetuned_twofold"
