...
import sys
from ms.model import TransPro, PrositIRT
...
for name, params in model.named_parameters():
    if "trans" in name or "embed" in name:
        pretrain.append(params)
    else:
        fine_tune.append(params)

# optimizer = torch.optim.AdamW(
#     [{'params': pretrain, 'lr': 0.001}, {'params': fine_tune, 'lr': 0.001}], lr=0.0001, eps=1e-8)
optimizer = torch.optim.AdamW(
